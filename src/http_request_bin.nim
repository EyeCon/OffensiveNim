#[
    ...
    - Use Nim's builtin httpclient library (which has its own HTTP implementation and uses raw sockets)
    ...
    - Use Winim's wininet or winhttp modules which call their respective Windows APIs
