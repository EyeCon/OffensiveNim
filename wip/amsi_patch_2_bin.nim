#[
    ...
    Because we're doing some memory patching here, that's sorta needed. You could use the emit pragma for this (??) but then you'd have to deal with the missing symbols.
